...
class BonusServiceTest {
    ...
    public static Stream<Arguments> testDataProvider() {
        return Stream.of(
                ...
                arguments("Значение из интервала, для не зарегистрированных пользователей", 10_000L, false, 100L),

                arguments("Верхняя граница - 1, для не зарегистрированных пользователей", 49_999L, false, 499L),
    ...
    @DisplayName("Параметризованный тест расчета бонусов для зарегистрированных и не зарегистрированных пользователей")
    @ParameterizedTest(name = "{index} - {0}, регистрация {2}, сумма {1}")
